...
""")
       ...
       if islem == 'a':
              ...
              ilce = input("Hangi İlçede Bulunmaktasınız: ")
              veri = requests.get("https://weathersapi.herokuapp.com/v1/country/TR/town/"+ilce+"/lang/tr-TR/tempUnit/c")
              y = json.loads(veri.text)
              print ("Sıcaklık: "+y['currentTemperature']['weatherTemperature'])
              print ("Nem: "+y["humidity"])
              print ("Yağış: "+y["currentTemperature"]["chanceOfRain"])
              print ("Rüzgar: "+y["wind"])
              #url_a = "https://weathersapi.herokuapp.com/v1/country/<countryId>/town/<townName>/lang/<lang>/tempUnit/<tempUnit>"
              ...
              while True:
                     secim = input("Seçenekler: toplama, çıkarma, çarpma, bölme, üsalma, kökalma,kapat -> ")
                     print(secim)
